...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string>
        GameLobbyDefaultPreset = CVarDef.Create("game.defaultpreset", "DistressSignal", CVar.ARCHIVE);
    ...
    /// </summary>
    public static readonly CVarDef<string>
        GameLobbyFallbackPreset = CVarDef.Create("game.fallbackpreset", "DistressSignal", CVar.ARCHIVE);
    ...
    public static readonly CVarDef<string> NewCharacterJobs =
        CVarDef.Create("game.new_character_jobs", "AU14JobGOVFORSquadRifleman", CVar.REPLICATED);
