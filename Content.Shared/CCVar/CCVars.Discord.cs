...
public sealed partial class CCVars
{
    ...
    /// <summary>
    ///     HEX color for the Discord round status embed when the server is in the lobby.
    /// </summary>
    ...
    /// <summary>
    ///     URL of the Discord webhook which will relay all mentor help messages.
    /// </summary>
    public static readonly CVarDef<string> DiscordMentorHelpWebhook =
        CVarDef.Create("discord.mentorhelp_webhook", string.Empty, CVar.SERVERONLY | CVar.CONFIDENTIAL);
